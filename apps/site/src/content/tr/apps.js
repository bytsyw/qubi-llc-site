const appsTr = [
  {
    ...
    downloads: "620K+",
    rating: "4.9/5",
    reviews: "18.2K değerlendirme",
    parents: "41K+ ebeveyn",
    dark: false,
    screenGradient: "from-[#fff8de] via-[#ffe58e] to-[#facc15]",
    glowClass: "bg-yellow-300/55",
    highlights: ["Etkileşimli bölümler", "Sakin ilerleyiş", "Ebeveyn dostu UX"],
    screenshots: ["Ana ekran", "Hikâye bölümü", "İlerleme görünümü", "Favoriler"],
    features: [
    ...
    faqs: [
      ...
      {
        question: "Platform bağlantıları daha sonra eklenebilir mi?",
        answer:
          "Evet. Bu sayfa yapısı, ürün yayına girdiğinde App Store ve Google Play bağlantılarının kolayca eklenebilmesi için hazırlanmıştır.",
      },
    ],
    steps: [
  ...
  },
  {
    ...
    downloads: "390K+",
    rating: "4.8/5",
    reviews: "12.4K değerlendirme",
    parents: "26K+ ebeveyn",
    dark: true,
    screenGradient: "from-[#111111] via-[#222222] to-[#facc15]",
    glowClass: "bg-yellow-300/40",
    highlights: ["Konuşma yönlendirmeleri", "Dinleme pratiği", "Günlük seri sistemi"],
    screenshots: [
      "Ders merkezi",
      "Dinleme modu",
    ...
    faqs: [
      ...
      {
        question: "Bu sayfa ileride mağaza listelerine bağlanabilir mi?",
        answer:
          "Evet. Yapı, gelecekteki App Store ve Google Play yayınları için lansmana hazır CTA alanları içerir.",
      },
    ],
    steps: [
  ...
  },
  {
    ...
    downloads: "210K+",
    rating: "4.7/5",
    reviews: "7.8K değerlendirme",
    parents: "17K+ ebeveyn",
    dark: false,
    screenGradient: "from-[#fff9df] via-[#ebf9cf] to-[#facc15]",
    glowClass: "bg-lime-200/55",
    highlights: ["Bulmaca döngüleri", "Odak rutinleri", "Alışkanlık oluşturan seanslar"],
    screenshots: ["Görev panosu", "Bulmaca turu", "Odak zamanlayıcısı", "Başarı duvarı"],
    features: [
    ...
    faqs: [
      ...
      {
        question: "Lansman mesajları daha sonra güncellenebilir mi?",
        answer:
          "Evet. Mevcut sayfa, daha sonra gerçek mağaza verileriyle değiştirilebilecek lansmana hazır yer tutucu içerik kullanır.",
      },
    ],
    steps: [
