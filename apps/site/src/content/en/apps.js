const appsEn = [
    {
      ...
      highlights: ["Interactive chapters", "Calm progression", "Parent-friendly UX"],
      screenshots: ["Home screen", "Story chapter", "Progress view", "Favorites"],
      features: [
      ...
      faqs: [
        ...
        {
          question: "Will platform links be available later?",
          answer:
            "Yes. The page is structured so App Store and Google Play links can be connected as soon as the product launches.",
        },
      ],
      steps: [
    ...
    },
    {
      ...
      highlights: ["Speaking prompts", "Listening practice", "Daily streak system"],
      screenshots: ["Lesson hub", "Listening mode", "Speaking prompt", "Weekly report"],
      features: [
      ...
      faqs: [
        {
          question: "What type of learning experience does Speaky Steps offer?",
          answer:
        ...
        {
          question: "Can this page later connect to store listings?",
          answer:
            "Yes. The structure already includes launch-ready CTA areas for future App Store and Google Play publishing.",
        },
      ],
      steps: [
    ...
    },
    {
      ...
      downloads: "210K+",
      rating: "4.7/5",
      reviews: "7.8K reviews",
      parents: "17K+ parents",
      dark: false,
      screenGradient: "from-[#fff9df] via-[#ebf9cf] to-[#facc15]",
      glowClass: "bg-lime-200/55",
      highlights: ["Puzzle loops", "Focus routines", "Habit-building sessions"],
      screenshots: ["Challenge board", "Puzzle round", "Focus timer", "Achievement wall"],
      features: [
      ...
      faqs: [
        ...
        {
          question: "Can launch messaging be updated later?",
          answer:
            "Yes. The current page uses placeholder launch-ready content that can be replaced with real marketplace data later.",
        },
      ],
      steps: [
