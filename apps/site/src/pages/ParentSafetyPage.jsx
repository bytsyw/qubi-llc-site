...
export default function ParentSafetyPage() {
  ...
  const cards = t("parentSafety.cards", { returnObjects: true });

  return (
    <>
      <Seo
        title={t("parentSafety.seo.title")}
        description={t("parentSafety.seo.description")}
      />
